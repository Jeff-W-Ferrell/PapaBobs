...
namespace PapaBobs.Domain
{
    public class PizzaPriceManager
    {
        public static decimal CalculateCost(DTO.OrderDTO order)
        {
            ...
            cost += CalcuateCrustCost(order, prices);
        ...
        private static decimal CalculateToppingsCost(OrderDTO order, DTO.PizzaPriceDTO prices)
        {
            ...
            cost += (order.Sausage) ? prices.SauasageCost : 0M;
        ...
        private static decimal CalcuateCrustCost(OrderDTO order, DTO.PizzaPriceDTO prices)
        {
            decimal cost = 0.0M;
